...
async def start_cmd(msg: Message, state: FSMContext):
    ...
    welcome_text = (
        "Привет, студент!\n\n"
        "Этот бот был создан <u>Студенческим советом ВШУ</u>, чтобы сделать твоё обучение комфортнее. Здесь ты можешь:\n\n"
        ...
        "<b>Твой вклад важен — вместе мы сделаем учёбу комфортнее!</b>\n\n"
        "<i>Бот был разработан Цифровыми Технологиями Информационного комитета</i>"
    )
